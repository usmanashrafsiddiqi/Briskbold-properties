...
const events = [
  { id: 1, title: "Tokyo Hosts BriskBold’s Dubai Property Showcase", image: "/japan1.jpg" },
...
const Event = () => {
  ...
  return (
    <>
    <div className="min-h-screen flex flex-col items-center text-white px-6 pt-28 pb-12 relative bg-gradient-to-br from-gray-800 via-gray-900 to-black">
