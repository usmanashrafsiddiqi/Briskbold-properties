        ...
        <div className='absolute top-0 left-0 w-full z-10'>
            <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
                ...
                <ul className='hidden md:flex gap-7 text-white'>
                    ...
                    <a
                        href="/crypto"
                        className="cursor-pointer bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 
               bg-[length:200%_100%] animate-gradient text-white px-6 py-2 
            ...
            {/* Mobile Menu */}
            <div className={`md:hidden ${showmobilemenu ? 'fixed w-full top-0 right-0 bottom-0' : 'h-0 w-0'} overflow-hidden transition-all duration-500 bg-gradient-to-br from-[#ff99a9] via-[#FFC3A0] to-[#FFE156] opacity-90`}>
